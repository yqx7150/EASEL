...
class ConditionalResidualBlock(nn.Module):
    def __init__(self, input_dim, output_dim, num_classes, resample=None, act=nn.ELU(),
        ...
        super().__init__()
        #print(input_dim, output_dim, num_classes)
...
class CondRefineNetDilated(nn.Module):
    def __init__(self, config):
        ...
        self.res1 = nn.ModuleList([
            ConditionalResidualBlock(10, self.ngf, self.num_classes, resample=None, act=act,
    ...
    def forward(self, x, y):
        ...
        layer1 = self._compute_cond_module(self.res1, x, y)
